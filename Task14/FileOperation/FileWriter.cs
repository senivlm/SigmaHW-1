namespace Task14
{
    internal class FileWriter : IDisposable
    {
        ...
        public void WriteToFile(bool IsApend = false)
        {
            ...
            {
                Console.WriteLine(ex.Message + "in method WriteToFile");
            }
            ...
            {
                Console.WriteLine(ex.Message + "exeption in method WriteToFile");
            }
        ...
        public void WriteToFile(string file, string fileName, bool IsApend)
        {
