namespace Task14
{
    internal class FileReader : IDisposable
    {
        ...
        public FileReader(string fileName)
        {
            ...
            rootPathFileLog = @"\..\..\..\Files\ProductsErrorLog\AddErrorLog.txt";
        ...
        public string ReadFileLine()
        {
            ...
            {
                Console.WriteLine(ex.Message + "in method ReadFileLine");
            }
            catch (ArgumentNullException ex)
            {
                Console.WriteLine(ex.Message + "in method ReadFileLine");
            ...
            {
                Console.WriteLine(ex.Message + "exeption in method ReadFileLine");
            }

            return lineRead ?? throw new ArgumentNullException();
        }
        ...
        public string ReadFileToEnd(string fileName)
        {
            ...
            {
                Console.WriteLine(ex.Message + "in method ReadFileToEnd");
            }
            catch (ArgumentNullException ex)
            {
                Console.WriteLine(ex.Message + "in method ReadFileToEnd");
            ...
            {
                Console.WriteLine(ex.Message + "exeption in method ReadFileToEnd");
            }
