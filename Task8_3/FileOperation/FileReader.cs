...
namespace Task8_3
{
    internal class FileReader : IDisposable
    {
        ...
        public FileReader(string fileName)
        {
            ...
            rootPath = @"D:\OlegLearning\SigmaHW\SigmaHW\Task8_3\Files\";
        ...
        public FileReader()
        {
            rootPath = @"D:\OlegLearning\SigmaHW\SigmaHW\Task_8_3\Files\";
            someText = "Ups....The info has not been read yet";
            rootPathFileLog = @"D:\OlegLearning\SigmaHW\SigmaHW\Task_8_3\Files\ProductsErrorLog\AddErrorLog.txt";
            fileName = "Products.txt";
            pathToFile = rootPath + fileName;
        }
